...
@Component({
  selector: 'app-super-add-vendor',
  templateUrl: './super-add-vendor.component.html',
  styleUrls: ['./super-add-vendor.component.css']
})
export class SuperAddVendorComponent implements OnInit {
  form!: FormGroup;
  countriesList: any;
  countryIds: any;
  statesLists: any;
